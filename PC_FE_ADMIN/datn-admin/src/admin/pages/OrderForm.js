      ...
      <div className="row">
            ...
            {orderDetail &&
              orderDetail.map((item, index) => (
                <li className="list-group-item d-flex justify-content-between lh-sm" key={index}>
                  ...
                  <strong>{(item.sellPrice * item.quantity).toLocaleString()} đ</strong>
                </li>
              ))}
            {sub > amount && (
        ...
        <div className="col-md-7 col-lg-8">
          ...
          <form className="needs-validation" onSubmit={handleSubmit(onSubmitHandler)}>
            ...
            <button className="btn btn-primary btn-lg mt-5 mb-5" type="submit" style={{ marginLeft: 680, borderRadius: 50 }}>
              Cập nhật
            </button>
          </form>
        </div>
